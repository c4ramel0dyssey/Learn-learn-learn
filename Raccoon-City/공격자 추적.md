...
### #2 공격자가 피싱에 사용한 피싱 도메인 (Phishing Domain)은 무엇인가요?  
...
### #3 이처럼 사람의 오타 가능성을 노려 유사한 철자(또는 문자)를 등록해 피싱·사기 등에 악용하는 기법을 무엇이라고 부르나요?  
...
### #4 이메일 본문에 포함된 링크를 통해 공격자가 시도한 공격 유형은 무엇일까요?  
